...
class ServidorHTTP {
    ...
    static void procesaPeticion(Socket socketCliente) throws IOException {
        ...
        if (peticion.startsWith("GET")) {
            ...
            if (peticion.length() == 0 || peticion.equals("/")) {
                ...
                printWriter.println("Date: " + generarFechaActual());
    ...
    private static String generarFechaActual() {
        DateFormat dateFormat = new SimpleDateFormat("EEE, d MM yyyy HH:mm:ss z", Locale.ENGLISH);
