                ...
                <div class="tab-content p-2 rounded-bottom" id="myTabContent" style="background-color: white;">
                    ...
                    <div class="tab-pane fade show active" id="agregar" role="tabpanel" aria-labelledby="agregar-tab">
                        <form action="Asignaturas" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="curso" class="form-label">Curso <span class="text-danger align-text-top">*</span></label>
                    ...
                    <!-- Formulario para borrar una Asignatura -->
                    <div class="tab-pane fade" id="borrar" role="tabpanel" aria-labelledby="borrar-tab">
                        <form action="Asignaturas" method="POST">
                            <div class="mb-3">
                                <label for="id" class="form-label">ID Asignatura <span class="text-danger align-text-top">*</span></label>
                    ...
                    <!-- Formulario para mostrar una Asignatura -->
                        ...
                        <form action="Asignaturas" method="POST">
                            <div class="input-group mt-3 mb-3">
                                <select class="form-select" name="option" id="option">
                                    ...
                                    <option value="todo">Mostrar todas las Asignaturas</option>
                                    <option value="id">Mostrar una Asignatura por su ID</option>
                                    <option value="nombre">Mostrar las Asignaturas por su Nombre</option>
                                    <option value="curso">Mostrar las Asignaturas por su Curso</option>
                                </select>
                                <label class="input-group-text" for="inputGroupSelect02">Busquedas</label>
                            </div>

                            <div class="mb-3" id="idOption" style="display: none;">
                                <label for="id" class="form-label">ID Asignaruta <span class="text-danger align-text-top"></span></label>
                                <input type="text" name="id" id="id" class="form-control">
                            </div>

                            <div class="mb-3" id="nombreOption" style="display: none;">
                                <label for="nombre" class="form-label">Nombre <span class="text-danger align-text-top"></span></label>
                                <input type="text" name="nombre" id="nombre" class="form-control">
                            </div>
                            
                            <div class="mb-3" id="cursoOption" style="display: none;">
                                <label for="curso" class="form-label">Curso <span class="text-danger align-text-top"></span></label>
        ...
        document.getElementById("option").addEventListener("click", function() {
            ...
            switch(this.value) {
                case "":
                    ...
                    document.getElementById("nombreOption").style.display = "none";
                    document.getElementById("cursoOption").style.display = "none";
                ...
                case "nombre":
                    document.getElementById("idOption").style.display = "none";
                    document.getElementById("nombreOption").style.display = "block";
                    document.getElementById("cursoOption").style.display = "none";
                    document.getElementById("submitMostrar").style.visibility = "visible";
                    break;
                ...
                case "curso":
                    document.getElementById("idOption").style.display = "none";
                    document.getElementById("nombreOption").style.display = "none";
                    document.getElementById("cursoOption").style.display = "block";
                    document.getElementById("submitMostrar").style.visibility = "visible";
                    break;
            }
        });
