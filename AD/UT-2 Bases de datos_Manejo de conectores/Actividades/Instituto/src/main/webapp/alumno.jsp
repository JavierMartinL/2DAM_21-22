...
<body>
                    ...
                    <div class="container-fluid">
                      ...
                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link" href="Alumnos">Alumno</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="Asignaturas">Asignatura</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="Matriculas">Matrícula</a>
                            </li>
                        </ul>
                      </div>
                    </div>
                ...
                <div class="tab-content p-2 rounded-bottom" id="myTabContent"style="background-color: white;">
                    ...
                    <div class="tab-pane fade show active" id="agregar" role="tabpanel" aria-labelledby="agregar-tab">
                        <form action="Alumnos" method="POST">
                            <div class="mb-3">
                                <label for="nombre" class="form-label">Nombre <span class="text-danger align-text-top">*</span></label>
                                <input type="text" name="nombre" id="nombre" class="form-control" required>
                            </div>

                            <div class="mb-3">
                                <label for="apellidos" class="form-label">Apellidos <span class="text-danger align-text-top"></span></label>
                                <input type="text" name="apellidos" id="apellidos" class="form-control">
                            </div>

                            <div class="mb-3">
                                <label for="nacimiento" class="form-label">Fecha Nacimiento <span class="text-danger align-text-top"></span></label>
                                <input type="text" name="nacimiento" id="nacimiento" class="form-control">
                            </div>

                            <div class="mb-3">
                                <label for="dni" class="form-label">DNI <span class="text-danger align-text-top">*</span></label>
                    ...
                    <!-- Formulario para mostrar un Alumno -->
                        ...
                        <form action="Alumnos" method="POST">
                            <div class="input-group mt-3 mb-3">
                                <select class="form-select" name="option" id="option">
                                    ...
                                    <option value="todo">Mostrar todos los Alumnos</option>
                                    <option value="dni">Mostrar un Alumno por su DNI</option>
                                    <option value="nombre">Mostrar los Alumnos por su Nombre</option>
                                    <option value="asignaturaAnio">Mostrar todos los Alumnos de una Asignatura y Año</option>
                                </select>
                                <label class="input-group-text" for="inputGroupSelect02">Busquedas</label>
                            </div>

                            <div class="mb-3" id="dniDiv" style="display: none;">
                                <label for="dni" class="form-label">DNI <span class="text-danger align-text-top"></span></label>
                            ...
                            <div id="asignaturaAnioDiv" style="display: none;">
                                <div class="mb-3">
                                    <label for="asignatura" class="form-label">ID Asignaruta <span class="text-danger align-text-top"></span></label>
    ...
    <!-- Evitar volver a enviar el formulario al recargar la pagina y controlar la accion del selector -->
    <script>
        ...
        document.getElementById("option").addEventListener("click", function() {
            ...
            switch(this.value) {
                case "":
                    document.getElementById("dniDiv").style.display = "none";
                    document.getElementById("nombreDiv").style.display = "none";
                    document.getElementById("asignaturaAnioDiv").style.display = "none";
                ...
                case "dni":
                    document.getElementById("dniDiv").style.display = "block";
                    document.getElementById("nombreDiv").style.display = "none";
                    document.getElementById("asignaturaAnioDiv").style.display = "none";
                    document.getElementById("submitMostrar").style.visibility = "visible";
                    break;
                ...
                case "asignaturaAnio":
                    document.getElementById("nombreDiv").style.display = "none";
                    document.getElementById("dniDiv").style.display = "none";
                    document.getElementById("asignaturaAnioDiv").style.display = "block";
                    document.getElementById("submitMostrar").style.visibility = "visible";
                    break;
            }
        })
